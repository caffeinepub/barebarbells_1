...
export class Backend implements backendInterface {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Product]): Promise<Product | null> {
